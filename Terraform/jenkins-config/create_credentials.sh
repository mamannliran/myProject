...
aws secretsmanager get-secret-value --secret-id nodejs-web-app5 --region ap-northeast-1 | python -c "import sys;import json;print(json.loads(json.loads(sys.stdin.read())['SecretString'])['private'])" > ssh_tmp
